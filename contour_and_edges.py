    ...
    for cnt in contours:
        ...
        if area > 500:
            ...
            cv2.putText(imgContour, objectType,
                        (x+w//3, y+(h-10)),
                        cv2.FONT_ITALIC, 0.5, COLOR, 2)


path = 'images\geometric_shapes.jpg'

img = cv2.imread(path)
print(img.shape)
imgCropped = img[40:350, :, :]
...
imgBlank = np.zeros_like(imgCropped)
imgStack = stackImages(0.8, ([imgCropped, imgGray, imgBlur],
